...
export const ClientLabel = (substitutes) =>
  Widget.Label({
    connections: [
      [
        Hyprland,
...
export const ClientIcon = (substitutes) =>
  Widget.Icon({
    connections: [
      [
        Hyprland,
  ...
  PanelButton({
    ...
    content: Widget.Box({
      children: [
        ClientIcon([
          [
            "com.transmissionbt.Transmission._43_219944-symbolic",
            "com.transmissionbt.Transmission-symbolic",
          ],
          [
            "com.transmissionbt.Transmission._40_219944-symbolic",
            "com.transmissionbt.Transmission-symbolic",
          ],
          [
            "com.transmissionbt.Transmission._37_219944-symbolic",
            "com.transmissionbt.Transmission-symbolic",
          ],
